...
exports.up = pgm => {
    ...
    */
    ...
    // Memberikan constrain foreign key pada kolom note_id dan user_id terhadap notes.id dan users.id
    pgm.addConstraint('collaborations', 'fk_collaborations_note_id', 'FOREIGN KEY (note_id) REFERENCES notes(id) ON DELETE CASCADE');
